...
export function NickMapControls (props:NickMapControlsComponentProps){
    ...
    return <div className="nickmap-controls">
        <div className="nickmap-controls-container-title">
            <button onClick={()=>set_hidden(!hidden)}>{hidden? "⏷" : "⏶"}</button>
        </div>
        <div className={hidden?'nickmap-controls-collapsible-body':'nickmap-controls-collapsible-body expanded'}>
            ...
            <div className="nickmap-controls-zoomto-container">
                ...
                </button>
                {
                    ...
                    <div className="nickmap-controls-zoomto-status">{
                        `Failed to find ${zoom_to_road} ${zoom_to_slk}: ${props.zoom_to_road_slk_state.reason}`
                    }</div>
                }
            </div>
        </div>
